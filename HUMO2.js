...
<div class="download-container">
    ...
    <div class="series-header">
        ...
        <div class="series-info">
            <h1>Enlaces de Descarga - Humo</h1>
    ...
    <div class="tab-content active" id="season-1">
        <div class="season-info">
            ...
            <div class="season-specs">
                <div class="season-spec">
                    ...
                    <div class="spec-value">Latino EAC3 JOC 5.1</div><div class="spec-value">Ingles EAC3 JOC 5.1</div></div><div class="season-spec"><div class="spec-label">FORMATO</div>
                ...
                <div class="season-spec">
                    ...
                    <div class="spec-value">1920 x 802</div>
                </div>
            </div>
        </div>
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">3.18 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~120 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/Hm011" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">1.98 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~82 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/HUM04" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <a class="download-button" href="https://tpi.li/HUM06" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
       ...
       <!--    <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">2.75 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~86 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/Te4DmF7" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
